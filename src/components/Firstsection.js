    ...
    return (
      <div id="Features" className="div_firstsec">
        <div className="first_part">
          <span> <b> <mark> Transforming </mark> the <br /> way higher
            education <br /> tranditionally works </b> </span> <br /> <br />
          Ever trought of how it would be if all the higer education is <br />
          transformed? Now just stop wondering and start experiencing  <br /> <br />
          <form>
            <div class="row">
              <div class="col col-9">
        ...
        <div className="second_part"><img src={mainimg} className='firstsec_img' /></div>
      </div>
    )
}
